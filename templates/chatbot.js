...
$(document).ready(function(){
   $("body").append('<iframe id="iframe_chatbot" src="{{URL}}/chatbot?app=1"  allowtransparency="true" src="" frameBorder="0"></iframe>');


  if ($.browser.mobile) {
    $("iframe#iframe_chatbot").addClass("mobile-iframe")
    $(window).scroll(function () {
      if ($(this).scrollTop() > 200) {
        $('div.chat-button').fadeOut();
      } else {
        $('div.chat-button').fadeIn();
      }
    });
  } else {
